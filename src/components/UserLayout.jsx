...
const UserLayout = ({ children }) => {
  ...
  return (
    <div className="user-layout min-h-screen overflow-x-hidden bg-white text-zinc-950 antialiased selection:bg-[#F5A800]/25 selection:text-black lg:bg-[#F7F6F4]">
      {/* Mobile overlay */}
      <AnimatePresence>
        {open && (
          <motion.button
      ...
      >
        ...
        <div className="mb-6 rounded-[20px] bg-zinc-950 p-5 text-white shadow-[0_1px_1px_rgba(0,0,0,0.1),0_16px_32px_-16px_rgba(0,0,0,0.5)] xl:mb-7 xl:p-6">
          ...
          <p className="mt-2 text-[12px] leading-relaxed text-zinc-400 xl:mt-3 xl:text-[13px]">
            Vendors nearby are active right now.
          </p>
        </div>
      ...
      <header className="fixed left-0 right-0 top-0 z-40 border-b border-zinc-200/70 bg-white/95 backdrop-blur-xl lg:left-[276px]">
        <div className="flex h-[72px] min-w-0 items-center justify-between gap-4 px-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-12">
          ...
          <div className="flex min-w-0 flex-1 items-center gap-3">
            ...
            <div className="hidden min-w-0 max-w-[560px] flex-1 items-center gap-3 rounded-[18px] border border-zinc-200 bg-white px-4 py-3 shadow-[0_1px_2px_rgba(0,0,0,0.03)] md:flex">
      ...
      <style>{`
        ...
        .user-layout .font-serif,
        .user-layout .font-display {
